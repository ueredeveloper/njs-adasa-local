...
exports.dis_tub_query = function () {
    ...
    SELECT 
           ...
           fin_finalidade =
            (SELECT
            (SELECT fin.ID_FINALIDADE id_finalidade,
                    fin.ID_TIPO_FINALIDADE id_tipo_finalidade,
                    fin.ID_INTERFERENCIA id_interferencia,
                    fin.VAZAO vazao,
                    fin.SUBFINALIDADE subfinalidade,
                    tf.DESCRICAO descricao,
                    tf.ID_TIPO_INTERFERENCIA id_tipo_interferencia
            ...
            ROOT('finalidades') ) AS finalidades),
    ...
    WHERE SUB.[ID_TIPO_POCO] = 2 AND I.ID_INTERFERENCIA = 2453
    `
}